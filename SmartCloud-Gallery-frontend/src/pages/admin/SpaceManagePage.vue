    ...
    <a-table :columns="columns" :data-source="dataList" :pagination="pagination" @change="doTableChange">
      <template #bodyCell="{ column, record }">
        ...
        <template v-if="column.dataIndex === 'spaceType'">
          <a-tag :color="SPACE_TYPE_MAP[record.spaceType] === '团队空间' ? 'green' : 'blue'">{{
            SPACE_TYPE_MAP[record.spaceType] }}</a-tag>
        </template>
        ...
        <template v-else-if="column.key === 'action'">
          <a-space wrap>
            ...
            <a-popconfirm title="你确定要删除该空间吗?" ok-text="确认" cancel-text="取消" @confirm="confirm(record.id)">
